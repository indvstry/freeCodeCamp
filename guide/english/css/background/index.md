...
In CSS color can be defined in following ways:
* A valid "color keyword" name such as `blue`
* A numerical color value
  ...
  + An RGBA color value (extended RGB model to include "alpha" for controlling opacity"
* HSL colors triple (Hue, Saturation, Lightness)
+ HSLA (HSL + alpha)
